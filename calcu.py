...
class app(Frame):
    def __init__(self):
        ...
        for number in ("789/" ,"456*","123-" ,"0.+"):
            ...
            for num in number:
                button(Functionnum , LEFT,num ,lambda storeObj=display,q=num:storeObj.set(storeObj.get()+q))


        EqualsButton = iCalc(self,TOP)
        for iequal in "=":
            if iequal == '=':
                btniEquals = button(EqualsButton,LEFT , iequal)
